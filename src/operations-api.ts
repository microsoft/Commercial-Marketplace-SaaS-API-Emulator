...
const configure: (app: Express, services: ServicesContainer) => void = (app, services) => {
  ...
  //
  app.get('/api/saas/subscriptions/:subscriptionId/operations', (async (req, res) => {
  ...
  //
  app.get('/api/saas/subscriptions/:subscriptionId/operations/:operationId', (async (req, res) => {
  ...
  // Subscriptions
  //
  app.patch('/api/saas/subscriptions/:subscriptionId/operations/:operationId', (async (req, res) => {
